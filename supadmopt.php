...
You are Welcome To Top Level <?php echo $_SESSION['topadun']; ?> Options. <a href="dminlogout.php">Logout</a>
</div>
<br>
<br><br />
<div class="container">
...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadmopt.php"><strong>Insert Super Administrator</strong></a></li>
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="deletesupad.php"><strong>Delete Super Administrator</strong></a></li>
</ul>
<hr>
</div></div>
<?php
...
<div class="alert alert-danger col-md-4 col-md-offset-4 col-xs-12 text-center">This user registration form creates Super adminstrator account.</div></div>
<div class="container">
<div class="row">
<div class="col-md-4 col-md-offset-4 col-xs-12">
<div class="panel panel-default">
<div class="panel-heading text-center">Super adminstrator registration form</div>
...
Copyright © 2019 Frank Akumbissah. All rights reserved.
        </div>
    </div>
    </div>
  </footer>
