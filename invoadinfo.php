...
<th><strong>Price for Medicine</strong></th>
...
<tr>
    ...
    <td align="center">GHS. <?php echo $row["price_of_med"]; ?></td>
    <td align="center">GHS. <?php echo $row["price_of_doc"]; ?></td>
    <td align="center"><?php echo $row["day_count"]; ?> </td>
    <td align="center">GHS. <?php echo $row["price_of_room"]; ?></td>
    <td align="center">GHS. <?php echo $row["ser_char"]; ?></td>
    <td align="center">GHS. <?php echo $row["totl"]; ?> </td>
