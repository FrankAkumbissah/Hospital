...
<form class="" action="" method="post" id="upform">
  ...
  <table height="500" width="500">
    ...
    <tr>
      ...
      <td width="250"><strong>GHS. <?php echo $row["price_of_med"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td width="200"><strong>Price for Doctors : </strong></td>
      <td width="250"><strong>GHS. <?php echo $row["price_of_doc"]; ?>.00</strong></td>
    </tr>


      <td ><strong>Count of Admitted Days</strong></td>
      <td ><strong><?php echo $row["day_count"]; ?></strong></td>

    </tr>
    <tr>
      <td >Price Per 1 room GHS.1000.00<br><strong>Price for Room : </strong></td>
      <td ><strong>GHS. <?php echo $row["price_of_doc"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td ><strong>Service Charge : </strong></td>
      <td ><strong>GHS. <?php echo $row["ser_char"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td ><strong>Total Price : </strong></td>
      <td ><strong>GHS. <?php echo $row["totl"]; ?>.00</strong></td>
    </tr>
  </table>
<br>
