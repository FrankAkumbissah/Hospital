...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  ...
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="invoadinfo.php"><strong>All Admitted Patients Invoices</strong></a></li>
...
<div class="row">
<div class="col-md-12 ">
<h4 style="font-family:calibri;" class="text-center">By clicking view, you can view or print patient invoice.</h4>
<br />
...
<tr>
    ...
    <td align="center">GHS. <?php echo $row["doc_charge"]; ?> </td>
    <td align="center">GHS. <?php echo $row["medi_charge"]; ?> </td>
    <td align="center">GHS. <?php echo $row["hos_charge"]; ?> </td>
    <td align="center">GHS. <?php echo $row["total_charge"]; ?></td>
