...
<form class="" action="" method="post" id="upform">
  ...
  <dd style="font-size:12px;"><input title="Use Only Letters" name="pfname" id="patifn" style="margin:5px" class="form-control" type="text" value="<?php echo $row["pet_fn"]; ?>"></dd>

  <dt style="font-size:12px;"><strong>Patient Last Name : </strong> </dt>
  <dd style="font-size:12px;"><input title="Use Only Letters" name="psname" id="patsn" style="margin:5px" class="form-control" type="text" value=" <?php echo $row["pet_sn"]; ?>" </dd>
