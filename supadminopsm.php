...
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadminop.php"><strong>Modify Patient Information</strong></a></li>
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadminopsm.php"><strong>Modify Staff Information</strong></a></li>
</ul>
</div></div>
...
<h4 style="font-family:calibri;" class="text-center alert alert-danger">Press Search Buttion to view all details</h4>
</div>
</div>
</div>
<div class="container">
...
<br>
  <dt style="font-size:12px;"><strong>Staff First Name : </strong> </dt>
...
<br>
  ...
  <dt style="font-size:12px;"><strong>Staff Last Name : </strong> </dt>
  ...
  <dt style="font-size:12px;"><strong>Staff Member Type: </strong></dt>
      <dd style="font-size:12px;">
      <select  id="gen" disabled style="margin:5px" name="gender" required="required"  class="form-control" placeholder="Select your Gendere">
  ...
  <dt style="font-size:12px;"><strong>Insertion Date and Time: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Updated By: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Update Date and Time: </strong></dt>
