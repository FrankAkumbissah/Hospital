...
<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>This is the Top level Adminstrator login form. Enter your login information to log into the system. </div>
	</div>
	</div>
	<br>
