...
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="sestaffactmem.php"><strong>Search Staff Member</strong></a></li>
...
<form id="sreg" name="sreg" action="" method="post">
  ...
  <tr>
    ...
    <div class="input-group col-md-12 col-xs-12"><input title="Use Only Letters"  id="fname" name="fname"   type="text" class="form-control" placeholder="First Name">
	</div>
    ...
    <tr>
    <td colspan="2" style="padding:5px">
    <div class="input-group col-md-12 col-xs-12"><input title="Use Only Letters" name="lname" id="lname"   type="text" class="form-control" placeholder="Last Name">
	</div>
    </td>
  </tr>
...
</html> <!-- required pattern="[A-Za-z]{1,30}" -->
