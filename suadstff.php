...
<h3 style="font-family:calibri;" class="text-center">Update Staff Member Information</h3></div>
</div>
</div>
</div>
...
<div class="row">
<div class="">
<h4 style="font-family:calibri;" class="text-center">Enable Fields using active field drop-down</h4>
<div class="container">
<div class="row">
...
<form class="" action="" method="post" id="upform">
  ...
  <dt style="font-size:12px;"><strong>Staff Member Reg.No :</strong> </dt>
  <dd style="font-size:12px;"><?php echo $row["staffID"]; ?></dd>

  <dt style="font-size:12px;"><strong>Staff Member First Name : </strong> </dt>
  <dd style="font-size:12px;"><input title="Use Only Letters" name="pfname" id="patifn" style="margin:5px" class="form-control" type="text" value="<?php echo $row["smfname"]; ?>"></dd>

  <dt style="font-size:12px;"><strong>Staff Member Last Name : </strong> </dt>
  <dd style="font-size:12px;"><input name="psname" id="patsn"  style="margin:5px" class="form-control" type="text" value=" <?php echo $row["smlname"]; ?>"></dd>

  <dt style="font-size:12px;"><strong>Staff Member Birth Day      : </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Staff Member Email: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Staff Member Gender: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Staff Member Address: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Staff Member Contact Number : </strong>
...
<footer>
	<hr />
    <center><h5 style="color:#FFF">Developed by Frank Akumbissah</h5><center>
</footer>
</html>
