...
<h3 style="font-family:calibri;" class="text-center">Admitted Patient Invoice</h3></div>
<br />
...
<tr>
    ...
    <tr>
        <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 ">Count of days (GHS.1000.00 per day)<input name="cod"  required="required"   type="number" class="form-control" placeholder="Count of days"></div></td>
        </tr>
