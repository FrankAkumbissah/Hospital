...
<form class="" action="" method="post" id="upform">
  ...
  <table height="500" width="500">
    ...
    <tr>
      ...
      <td width="250"><strong>GHS. <?php echo $row["medi_charge"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td width="200"><strong>Price for Doctors : </strong></td>
      <td width="250"><strong>GHS. <?php echo $row["doc_charge"]; ?>.00</strong></td>


    <tr>
      <td ><strong>Service Charge : </strong></td>
      <td ><strong>GHS. <?php echo $row["hos_charge"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td ><strong>Total Price : </strong></td>
      <td ><strong>GHS. <?php echo $row["total_charge"]; ?>.00</strong></td>
    </tr>
  </table>
<br>
