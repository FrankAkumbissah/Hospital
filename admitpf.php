...
<h3 class="panel-title text-center">Admitted Patient Information</h3>
</div>
<center>
...
<?php
$id=$_REQUEST['id'];
$query = "SELECT admit_pet.admit_age,patient.pet_ac,admit_pet.admit_petid,admit_pet.admit_name,admit_pet.admit_con,admit_pet.admit_bg,admit_pet.pet_des,admit_pet.pet_id
FROM admit_pet
RIGHT JOIN patient
