...
session_start();
	...
	if (isset($_POST['sadmun'])){
		...
		$typeb = "Basic Administrator";
		$typea = "Super Administrator";
...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>This is the main system login form for access. You can enter both Super and Basic admin login details. If you are not a member of the system, create your login access using <a target="_blank" style="font-colour="Blue"" href='superadmin.php'>Register Here</a>
<br>
	<br>Enter Login details provided by the Hospital Administration. </div>
	</div>
