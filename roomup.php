...
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4 col-xs-12 alert alert-success text-center">Select Doctor to Check the room.</div>
</div>
</div>
...
<div align="left"> Select Doctor Incharge in Morning :</div>
    <select required  name="mrdo"  style="margin:5px;  border-radius:0px" class="form-control">
    <option value="">Select Doctor Incharge in Morning :</option>
    <?php
        $count = 1;
    ...
    <div align="left"> Select Doctor Incharge in Evening :</div>
        <select required  name="erdo"  style="margin:5px;  border-radius:0px" class="form-control">
        <option value="">select Doctor Incharge in Evening :</option>
        <?php
            $count = 1;
